...
RefreshTokenGrantType.prototype.handle = async function handle(request, client) {
  if (!request) {
...
RefreshTokenGrantType.prototype.getRefreshToken = function getRefreshToken(request, client) {
...
RefreshTokenGrantType.prototype.revokeToken = function revokeToken(token) {
...
RefreshTokenGrantType.prototype.saveToken = async function saveToken(user, client, scope) {
  const fns = [
