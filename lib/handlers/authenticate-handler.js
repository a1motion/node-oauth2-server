...
AuthenticateHandler.prototype.handle = async function handle(request, response) {
...
AuthenticateHandler.prototype.getTokenFromRequest = function getTokenFromRequest(request) {
...
AuthenticateHandler.prototype.getTokenFromRequestHeader = function getTokenFromRequestHeader(request) {
...
AuthenticateHandler.prototype.getTokenFromRequestQuery = function getTokenFromRequestQuery(request) {
...
AuthenticateHandler.prototype.getTokenFromRequestBody = function getTokenFromRequestBody(request) {
...
AuthenticateHandler.prototype.getAccessToken = function getAccessToken(token) {
  return promisify(this.model.getAccessToken, 1)
...
AuthenticateHandler.prototype.validateAccessToken = function validateAccessToken(accessToken) {
...
AuthenticateHandler.prototype.verifyScope = function verifyScope(accessToken) {
...
AuthenticateHandler.prototype.updateResponse = function updateResponse(response, accessToken) {
