...
TokenHandler.prototype.handle = async function handle(request, response) {
...
TokenHandler.prototype.getClient = function getClient(request, response) {
  ...
  return promisify(this.model.getClient, 2)
    .call(this.model, credentials.clientId, credentials.clientSecret)
    .then((client) => {
      if (!client) {
...
TokenHandler.prototype.getClientCredentials = function getClientCredentials(request) {
...
TokenHandler.prototype.handleGrantType = function handleGrantType(request, client) {
  const grantType = request.body.grant_type;
...
TokenHandler.prototype.getAccessTokenLifetime = function getAccessTokenLifetime(client) {
...
TokenHandler.prototype.getRefreshTokenLifetime = function getRefreshTokenLifetime(client) {
...
TokenHandler.prototype.getTokenType = function getTokenType(model) {
...
TokenHandler.prototype.updateSuccessResponse = function updateSuccessResponses(response, tokenType) {
...
TokenHandler.prototype.updateErrorResponse = function updateErrorResponse(response, error) {
  response.body = {
    error: error.name,
 ...
 */
TokenHandler.prototype.isClientAuthenticationRequired = function isClientAuthenticationRequired(grantType) {
